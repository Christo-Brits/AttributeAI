...
export default AIChatInterface;              display: 'flex',
              alignItems: 'center',
            ...
            <div style={{ flex: 1 }}>
              <div style={{
                background: message.type === 'ai' ? '#f3f4f6' : '#3b82f6',
                color: message.type === 'ai' ? '#1f2937' : '#fff',
                padding: '0.75rem',
                borderRadius: '12px',
                fontSize: '0.875rem',
                lineHeight: '1.5',
      ...
      <div style={{
        ...
        <div style={{
          ...
          <input
            ...
            onChange={(e) => setInputMessage(e.target.value)}
            onKeyPress={handleKeyPress}
            placeholder="Ask about attribution, performance, or strategy..."
            disabled={isLoading}
            style={{
              flex: 1,
              padding: '0.75rem',
          ...
          <button
            ...
            style={{
              padding: '0.75rem',
              background: isLoading || !inputMessage.trim() ? '#d1d5db' : '#3b82f6',
              color: '#fff',
              border: 'none',
              borderRadius: '8px',
        ...
        <div style={{
          ...
          {SupabaseApiService.isUsingSupabaseFunctions() 
            ? '🌐 Enterprise Edge Functions Active' 
            : '🔧 Development Mode'
          }
        </div>
      </div>
