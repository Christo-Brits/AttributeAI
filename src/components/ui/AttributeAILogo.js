      ...
      <div className={`flex flex-col items-center ${className}`}>
        ...
        {showText && (
          <div className="text-center">
            ...
            <div className="text-xs text-gray-500 mt-1">Marketing Intelligence</div>
          </div>
        )}
      </div>
    );
    ...
    <div className={`flex items-center ${className}`}>
      ...
      {showText && (
        <div className="ml-3">
          ...
          <div className="text-xs text-gray-500 -mt-1">Marketing Intelligence Attribution</div>
        </div>
      )}
    </div>
  );
...
export default AttributeAILogo;